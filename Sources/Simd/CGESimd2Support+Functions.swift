...
@inlinable
public func abs<T: CGESimd2Support>(_ x: T) -> T {
	return T(abs(x.simd))
}
...
@inlinable
public func ceil<T: CGESimd2Support>(_ x: T) -> T {
...
@inlinable
public func clamp<T: CGESimd2Support>(_ x: T, min: CGFloat, max: CGFloat) -> T {
	return T(clamp(x.simd, min: min.native, max: max.native))
}

/// Distance between `x` and `y`.
@inlinable
public func distance<T: CGESimd2Support>(_ x: T, _ y: T) -> CGFloat {
	return CGFloat(distance(x.simd, y.simd))
}

/// Distance between `x` and `y`, squared.
@inlinable
public func distance_squared<T: CGESimd2Support>(_ x: T, _ y: T) -> CGFloat {
	return CGFloat(distance_squared(x.simd, y.simd))
}

/// Dot product of `x` and `y`.
@inlinable
public func dot<T: CGESimd2Support>(_ x: T, _ y: T) -> CGFloat {
...
@inlinable
public func floor<T: CGESimd2Support>(_ x: T) -> T {
	return T(floor(x.simd))
}

/// Length (two-norm or "Euclidean norm") of `x`.
@inlinable
public func length<T: CGESimd2Support>(_ x: T) -> CGFloat {
	return CGFloat(length(x.simd))
}

/// Length of `x`, squared.
@inlinable
public func length_squared<T: CGESimd2Support>(_ x: T) -> CGFloat {
...
@inlinable
public func max<T: CGESimd2Support>(_ x: T, _ y: T) -> T {
...
@inlinable
public func max<T: CGESimd2Support>(_ vector: T, _ scalar: CGFloat) -> T {
...
@inlinable
public func min<T: CGESimd2Support>(_ x: T, _ y: T) -> T {
...
/// corresponding element of the input vector and the scalar.
@inlinable
public func min<T: CGESimd2Support>(_ vector: T, _ scalar: CGFloat) -> T {
	return T(min(vector.simd, scalar.native))
}

/// The infinity-norm (or "sup norm") of `x`.
@inlinable
public func norm_inf<T: CGESimd2Support>(_ x: T) -> CGFloat {
	return CGFloat(norm_inf(x.simd))
}

/// The one-norm (or "taxicab norm") of `x`.
@inlinable
public func norm_one<T: CGESimd2Support>(_ x: T) -> CGFloat {
	return CGFloat(norm_one(x.simd))
}

/// Unit vector pointing in the same direction as `x`.
@inlinable
public func normalize<T: CGESimd2Support>(_ x: T) -> T {
	return T(normalize(x.simd))
}

/// Projection of `x` onto `y`.
@inlinable
public func project<T: CGESimd2Support>(_ x: T, _ y: T) -> T {
	return T(project(x.simd, y.simd))
}

/// Elementwise reciprocal.
@inlinable
public func recip<T: CGESimd2Support>(_ x: T) -> T {
	return T(recip(x.simd))
}

/// Sum of the elements of the vector.
@inlinable
public func reduce_add<T: CGESimd2Support>(_ x: T) -> CGFloat {
	return CGFloat(reduce_add(x.simd))
}

/// Sum of the elements of the vector.
@inlinable
public func reduce_max<T: CGESimd2Support>(_ x: T) -> CGFloat {
	return CGFloat(reduce_max(x.simd))
}

/// Minimum element of the vector.
@inlinable
public func reduce_min<T: CGESimd2Support>(_ x: T) -> CGFloat {
...
/// is [1,2,-3].
@inlinable
public func reflect<T: CGESimd2Support>(_ x: T, n: T) -> T {
...
@inlinable
public func refract<T: CGESimd2Support>(_ x: T, n: T, eta: CGFloat) -> T {
	return T(refract(x.simd, n: n.simd, eta: eta.native))
}

/// Elementwise reciprocal square root.
@inlinable
public func rsqrt<T: CGESimd2Support>(_ x: T) -> T {
...
@inlinable
public func sign<T: CGESimd2Support>(_ x: T) -> T {
...
@inlinable
public func smoothstep<T: CGESimd2Support>(_ x: T, edge0: T, edge1: T) -> T {
	return T(smoothstep(x.simd, edge0: edge0.simd, edge1: edge1.simd))
}

/// 0.0 if `x < edge`, and 1.0 otherwise.
@inlinable
public func step<T: CGESimd2Support>(_ x: T, edge: T) -> T {
...
@inlinable
public func trunc<T: CGESimd2Support>(_ x: T) -> T {
